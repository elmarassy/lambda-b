...
namespace FCCAnalyses {
    namespace myUtils {
        ...
        struct buildLb2LMuMu {
            ...
            ROOT::VecOps::RVec<FCCAnalysesComposite2> hadrons2; //hadron2 momentumla
            ...
            ROOT::VecOps::RVec<double_t> primaryLbImpactParameters; //minimal distance between reconstructed lambdaB path and primary vertex
            ROOT::VecOps::RVec<double_t> muonHadronImpactParameters; //minimal distance between dihadron path and dimuon vertex
            ROOT::VecOps::RVec<double_t> displacementProduct;
        ...
        struct testing2 {
            ...
            ROOT::VecOps::RVec<FCCAnalysesComposite2> newHadrons2; //hadron2 momentumla
            ...
            ROOT::VecOps::RVec<FCCAnalysesComposite2> oldDimuons; //dimuon momentum
            ROOT::VecOps::RVec<FCCAnalysesComposite2> oldMuons1; //muon1 momentum
            ROOT::VecOps::RVec<FCCAnalysesComposite2> oldMuons2; //muon2 momentum

            ROOT::VecOps::RVec<FCCAnalysesComposite2> oldDihadrons; //dihadron momentum
            ROOT::VecOps::RVec<FCCAnalysesComposite2> oldHadrons1; //hadron1 momentum
            ROOT::VecOps::RVec<FCCAnalysesComposite2> oldHadrons2; //hadron2 momentumla

            ROOT::VecOps::RVec<FCCAnalysesComposite2> oldTotals;
            //total momentum (dimuon + dihadron = lambdaB for valid selection)

            ROOT::VecOps::RVec<double_t> oldFlightDistancesLb; //distance from dimuon vertex to primary vertex
            ROOT::VecOps::RVec<double_t> oldFlightDistancesL; //distance from dihadron vertex to dimuon vertex
        ...
        std::pair<ROOT::VecOps::RVec<FCCAnalysesComposite2>, ROOT::VecOps::RVec<FCCAnalysesComposite2> > build_Lb2LMuMu(
            ROOT::VecOps::RVec<VertexingUtils::FCCAnalysesVertex> vertex,
            ROOT::VecOps::RVec<edm4hep::ReconstructedParticleData> recop,
            bool clean); //, ROOT::VecOps::RVec<int> recind, ROOT::VecOps::RVec<int> mcind);
        ...
        struct build_D0 {
            ...
            ROOT::VecOps::RVec<FCCAnalysesComposite> operator()(
                ROOT::VecOps::RVec<edm4hep::ReconstructedParticleData> recop,
        ...
        struct build_tau23pi {
            ...
            ROOT::VecOps::RVec<FCCAnalysesComposite2> operator()(
                ROOT::VecOps::RVec<VertexingUtils::FCCAnalysesVertex> vertex,
                ROOT::VecOps::RVec<edm4hep::ReconstructedParticleData> recop);
        };
        ...
        ROOT::VecOps::RVec<edm4hep::ReconstructedParticleData> PID(
            ROOT::VecOps::RVec<edm4hep::ReconstructedParticleData> recop,
