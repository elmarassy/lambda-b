...
class analysis():
    ...
    #__________________________________________________________python analysis_lambda.py ./lambda_new/clean2.root /data/submit/lhcb/fccee_samples/p8_ee_Zbb_ecm91_EvtGen_Lb2LMuMu/events_069151978.root
